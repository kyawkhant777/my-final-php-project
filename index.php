    ...
    <body>
        ...
        <main>
            ...
            <section class="slick-slideshow">   
                ...
                <div class="slick-custom">
                    <img src="images/slideshow/slide 1.jpg" class="img-fluid" alt="">
</div>
<div class="slick-custom">
                    <img src="images/slideshow/sllide 3.jpg" class="img-fluid" alt="">
</div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <h2 class="mb-5">Get started with <span>Little</span> Fashion Shop</h2>
                        </div>
                        ...
                        <div class="col-lg-2 col-12 mt-auto mb-auto">
                            <ul class="nav nav-pills mb-5 mx-auto justify-content-center align-items-center" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-youtube-tab" data-bs-toggle="pill" data-bs-target="#pills-youtube" type="button" role="tab" aria-controls="pills-youtube" aria-selected="true">How our shop work?</button>
                                </li>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="images/wholesale shop owner.jpg" class="img-fluid" alt="">
                        </div>

                        <div class="col-lg-6 col-12">
                            <div class="px-5 py-5 py-lg-0">
                                
                                <h2 class="mb-4"><span>Wholesale</span> shop owner</h2>

                                <p class="lead mb-4">Hello Sir, Welcome To My Shop</p>
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="order.php" class="product-title-link">Tree pot</a>
                                        </h5>
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="order.php" class="product-title-link">Fashion Set</a>
                                        </h5>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="order.php" class="product-title-link">Juice Drinks</a>
                                        </h5>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="order.php" class="product-title-link">Coffee Drinks</a>
                                        </h5>

                                        <p class="product-p">This is the delicious taste for you</p>
                                    </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="order.php" class="product-title-link">Premium Lattop</a>
                                        </h5>

                                        <p class="product-p">This is can useful for you</p>
                                    </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="order.php " class="product-title-link">Ligher Fashion</a>
                                        </h5>

                                        <p class="product-p">If you can wear light fasjion you should choice this</p>
                                    </div>
