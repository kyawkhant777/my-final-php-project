                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 header-info">
                            <h1>
                                ...
                                <span class="d-block text-dark">Team Design</span>
                                <span class="d-block text-dark">Images</span>
                            </h1>
                        </div>
                    </div>
                </div>

                <img src="images/header/h1.jpg" class="header-image img-fluid" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-4 col-12">
                            <div class="team-thumb d-flex align-items-center">
                                <img src="images/people/ceo.jpg" class="img-fluid custom-circle-image team-image me-4" alt="">

                                <div class="team-info">
                                    <h5 class="mb-0">Phillar</h5>
                                    <strong class="text-muted">Shop CEO</strong>
                        ...
                        <div class="col-lg-4 mb-4 col-12">
                            <div class="team-thumb d-flex align-items-center">
                                ...
                                <div class="team-info">
                                    <h5 class="mb-0">Helen</h5>
                                    <strong class="text-muted">Marketing Manager</strong>
                        ...
                        <div class="col-lg-4 mb-lg-0 mb-4 col-12">
                            <div class="team-thumb d-flex align-items-center">
                                ...
                                <div class="team-info">
                                    ...
                                    <strong class="text-muted">Founder Manager</strong>
                        ...
                        <div class="col-lg-4 mb-4 col-12">
                            <div class="team-thumb d-flex align-items-center">
                                <img src="images/people/sale super.jpg" class="img-fluid custom-circle-image team-image me-4" alt="">

                                <div class="team-info">
                                    <h5 class="mb-0">Hanner</h5>
                                    <strong class="text-muted">Sale Supervisor</strong>
                        ...
                        <div class="col-lg-4 mb-4 col-12">
                            <div class="team-thumb d-flex align-items-center">
                                <img src="images/people/sale admin .jpg" class="img-fluid custom-circle-image team-image me-4" alt="">

                                <div class="team-info">
                                    <h5 class="mb-0">Phillips</h5>
                                    <strong class="text-muted">Sale Admin</strong>
                        ...
                        <div class="col-lg-4 mb-4 col-12">
                            <div class="team-thumb d-flex align-items-center">
                                <img src="images/people/sale rep.j[g.jpg" class="img-fluid custom-circle-image team-image me-4" alt="">

                                <div class="team-info">
                                    <h5 class="mb-0">Marry Jame</h5>
                                    <strong class="text-muted">Sale Representative</strong>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-9 mx-auto col-11">
                            <h2 class="text-center">Customer love, <br> <span>Little</span> Fashion  Shop</h2>

                            <div class="slick-testimonial">
                                <div class="slick-testimonial-caption">
                                    <p class="lead">Over three years in business, We’ve had the chance to work on a variety of projects, with Kyaw Gyi Companies CO.LTD</p>

                                    <div class="slick-testimonial-client d-flex align-items-center mt-4">
                                        <img src="images/people/art fashion .jpg" class="img-fluid custom-circle-image me-3" alt="">

                                        <span>Geoge Clayson, <strong class="text-muted">Digital Art Fashion Director</strong></span>
                                    </div> 
                                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-10 me-auto mb-4">
                        <h4 class="text-white mb-3"><a href="index.php">Little</a> Fashion Shop</h4>
